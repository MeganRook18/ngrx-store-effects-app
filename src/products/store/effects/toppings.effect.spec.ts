/**
 * Marble Testing
 * ref: https://github.com/ReactiveX/rxjs/blob/master/docs_app/content/guide/testing/internal-marble-tests.md
 *
 * Marble Tests are tests that use a specialized VirtualScheduler called the TestScheduler.
 * They enable us to test asynchronous operations in a synchronous and dependable manner.
 */
